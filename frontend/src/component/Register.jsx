        ...
        setError(
          err.response.data.error
            ...
            : err.response.data?.includes(
                '"password" with value "password" fails to match the required pattern'
              )
            ? "password must contain 8 characters, 1 uppercase, 1 lowercase, 1 special character ,and 1 number"
            : err.response?.data
        );
      });
  };
        ...
        <form onSubmit={handleRegisterUser}>
            ...
            <CancelIcon
              className={
                !checkIfPasswordMatches
                  ? "togglePassword passwordError d-block"
                  : "togglePassword passwordError d-none"
              }
            />
            <CheckCircleIcon
              className={
                checkIfPasswordMatches
                  ? "togglePassword passwordCorrection d-block"
                  : "togglePassword passwordCorrection d-none"
              }
            />
          </div>
          <div className="passwordInput ">
          ...
          <div className="d-flex">
            {checkIfPasswordMatches ? (
              ...
              <div className="d-flex">
                <button
                  className="button mt-3 me-3"
                  type="submit"
                  title="Make Sure all the fields are filled!"
                  disabled
                >
                  Create Account
                </button>{" "}
